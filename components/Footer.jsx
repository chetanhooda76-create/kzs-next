        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/kzsmalik/" target="_blank" className="w-10 h-10 text-white rounded-full flex items-center justify-center transition-all hover:scale-110 active:scale-95 shadow-lg shadow-[#d6249f]/20" style={{ background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)' }} title="Instagram"><FaInstagram size={18} /></a>
